...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { end_weight: @weight.end_weight, start_weight: @weight.start_weight } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { end_weight: @weight.end_weight, start_weight: @weight.start_weight } }
